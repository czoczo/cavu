...
Despite editing configuration differs depending on deployment method ([Helm Chart](/deployment/10_deploy_helm_chart/) or [Docker Compose](/deployment/20_deploy_docker/)), body of YAML configuration is the same.



Below is an example of their content with a description of the fields.
