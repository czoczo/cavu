...
Despite editing configuration differs depending on deployment method ([Helm Chart](/deployment/deploy_helm_chart/) or [Docker Compose](/deployment/deploy_docker/)), body of YAML configuration is the same.
